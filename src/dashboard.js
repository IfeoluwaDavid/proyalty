          ...
          <Table aria-labelledby="tableTitle" size={dense ? "small" : "medium"}>
            ...
            >
              ...
              {stableSort(artists, getComparator(order, orderBy))
                ...
                .map((artistObj, index) => {
                  const isItemSelected = isSelected(artistObj.id);
                  const labelId = `enhanced-table-checkbox-${index}`;
                  return (
                    <TableRow
                      hover
                      onClick={(event) => handleClick(event, artistObj.id)}
                      role="checkbox"
                    ...
                    >
                      ...
                      <TableCell>{artistObj.name}</TableCell>
                      <TableCell>{artistObj.rate}</TableCell>
                      <TableCell>{artistObj.streams}</TableCell>
                      <TableCell>{artistObj.payout}</TableCell>
                      <TableCell>{JSON.stringify(artistObj.paidOut)}</TableCell>
